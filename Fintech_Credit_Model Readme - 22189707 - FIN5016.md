# SBA Loan Default Prediction Model: Credit Risk Model for Loan Approval
...
2. Ensure the required libraries such as `pandas`, `numpy`, `matplotlib`, `seaborn`, and `scikit-learn` are installed.
3. Open `Fintech_Credit_Model_Final.ipynb` and run all cells in order.
